...
if (!function_exists('page')) {
    function page($sumPage, $page, $URL = '')
    {
        ...
        #Về đầu trang
        $html .= '<li class="page-item"><a  class="page-link" href="'. \App\Helpers\Helper::getFillter(['page' => 1]) .'">Đầu</a></li>';

        #Về trước 1 trang
        #Nếu trang hiện tại lớn hơn 1 => trước
        if ($page > 1) {
            $html .= '<li class="page-item"><a class="page-link" href="' . \App\Helpers\Helper::getFillter(['page' => ($page - 1)]). '">Trước</a></li>';
        }
        ...
        for ($i = $start; $i <= $end; $i++) {
            if ($page == $i) {
                ...
                $html .= '<li class="page-item"><a class="page-link" href="' . \App\Helpers\Helper::getFillter(['page' => $i]). ' ">' . $i . '</a></li>';
            }
        }
        ...
        if ($page < $sumPage) {
            $html .= '<li class="page-item"><a class="page-link" href="' . \App\Helpers\Helper::getFillter(['page' => ($page + 1)] ) .'">Sau</a></li>';
        }

        #Về cuối trang
        $html .= '<li class="page-item"><a class="page-link" href="'. \App\Helpers\Helper::getFillter(['page' => $sumPage] ).'">Cuối</a></li>
        </ul>';
